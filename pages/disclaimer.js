		...
		<div className={'mt-2 w-full'}>
			<div className={'p-6 bg-white'}>
				...
				<div className={'text-justify'}>
					<p className={'pb-6 text-gray-blue-1 dark:text-gray-3'}>
					...
					<p className={'text-gray-blue-1 dark:text-gray-3'}>
						...
						<a href={'https://docs.yearn.finance'} target={'_blank'} rel={'noreferrer'} className={'text-yearn-blue link'}>{'documentation'}</a>
						{' and '}
						<a href={'https://github.com/yearn/'} target={'_blank'} rel={'noreferrer'} className={'text-yearn-blue link'}>{'code'}</a>
						{' before use.'}
					</p>
				</div>
			</div>
