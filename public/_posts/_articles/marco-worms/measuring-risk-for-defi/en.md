...
![](./image7.jpg?w=900&h=230)

- Only claim COMP rewards (claim COMP rewards):

![](./image8.jpg?w=900&h=129)

By doing these 5 actions, we interacted with at least two contracts:
...
The Compound protocol has been reviewed & audited by [Trail of Bits](https://www.trailofbits.com/) and [OpenZeppelin](https://www.openzeppelin.com/) and it is one of the most reputable protocols in DeFi for lending, existing since Sep 2018, so a score of 1 makes sense in this context.
